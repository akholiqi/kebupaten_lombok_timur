                        ...
                        children: [
                          Align(
                            ...
                            child: InkWell(
                              ...
                              child: Image.network(
                                'https://www.libur.co/wp-content/uploads/2022/04/Pulau-Padamarang.jpg',
                                width: double.infinity,
                                height: 800,
                                fit: BoxFit.cover,
                              ),
                                    ...
                                    itemBuilder: (context, index) {
                                      return [
                                        () => ClipRRect(
                                              ...
                                              child: Image.network(
                                                'https://www.celebes.co/wp-content/uploads/2019/12/Pulau-Bintang-1.jpg',
                                                width: 300,
                                                height: 262,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        () => ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8),
                                              child: Image.network(
                                                'https://www.celebes.co/wp-content/uploads/2020/11/Spot-Foto-Estetik-di-Danau-Biru.jpg',
                                                width: 300,
                                                height: 200,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        () => ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8),
                                              child: Image.network(
                                                'https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1608967547/aow7spfk45pcnezadxto.jpg',
                                                width: 300,
                                                height: 240,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        () => ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8),
                                              child: Image.network(
                                                'https://www.libur.co/wp-content/uploads/2022/04/Tanjung-Kayu-Angin.jpg.webp',
                                                width: 300,
                                                height: 357,
                                                fit: BoxFit.cover,
                                              ),
                                        ...
                                        () => ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8),
                                              child: Image.network(
                                                'https://www.celebes.co/wp-content/uploads/2019/12/Villa-Rumah-Adat-Mekongga-Kolaka-1.jpg',
                                                width: 300,
                                                height: 221,
                                                fit: BoxFit.cover,
                                              ),
